...
int throw_cost( const Character &c, const item &to_throw )
{
    ...
    move_cost += to_throw.bonus_from_enchantments( c, move_cost, enchantment_value_id( "ITEM_THROW_ATTACK_COST" ), true );
    // Then apply character enchant
    move_cost += bonus_from_enchantments( move_cost, enchantment_value_id( "THROW_ATTACK_COST" ), true );
